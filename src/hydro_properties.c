...
void hydro_props_init(struct hydro_props *p,
  ...
  mhd_builtin_init(params, us, phys_const, &(p->mhd_builtin));
#endif
...
#ifdef MHD_BUILTIN_ENABLED
  mhd_builtin_print(&(p->mhd_builtin));
#endif
...
#ifdef MHD_BUILTIN_ENABLED
  mhd_builtin_print_snapshot(h_grpsph, &(p->mhd_builtin));
#endif
}
#endif
...
#ifdef MHD_BUILTIN_ENABLED
  mhd_builtin_init_no_hydro(&(p->mhd_builtin));
#endif
}
