...
#ifndef SWIFT_DENSITY_REACTIVE_HYDRO_DEBUG_H
#define SWIFT_DENSITY_REACTIVE_HYDRO_DEBUG_H

/**
 * @file DENSITY_REACTIVE/hydro_debug.h
...
#endif /* SWIFT_DENSITY_REACTIVE_HYDRO_DEBUG_H */
