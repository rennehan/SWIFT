 ...
 *
 ******************************************************************************/
#ifndef SWIFT_DENSITY_REACTIVE_HYDRO_CSDS_H
#define SWIFT_DENSITY_REACTIVE_HYDRO_CSDS_H
...
INLINE static int csds_hydro_define_fields(struct csds_field *fields) {
  ...
  /* Grouped field */
  csds_define_field_from_function_hydro(fields[8], "DENSITY_REACTIVESecondaryFields",
...
#endif  // WITH_CSDS
#endif  // SWIFT_DENSITY_REACTIVE_HYDRO_CSDS_H
