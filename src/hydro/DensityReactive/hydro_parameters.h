...
#ifndef SWIFT_DENSITY_REACTIVE_HYDRO_PARAMETERS_H
#define SWIFT_DENSITY_REACTIVE_HYDRO_PARAMETERS_H
...
/**
 * @file DENSITY_REACTIVE/hydro_parameters.h
 * @brief Density-Energy conservative implementation of SPH,
 *        with added DENSITY_REACTIVE physics (Rennehan 2025) 
...
/*! Density-Reactive parameters -- FIXED -- MUST BE DEFINED AT COMPILE-TIME */

/*! Density contrast indicator minimum --- indicates that there is a large
 * density gradientin the kernel when this fraction of particles have a
 * serious major difference from self. */
#define const_rho_gradient_minimum_chi 0.3f
#define const_P_gradient_minimum_chi 1.f

/*! The log10 of factor pj->rho / pi->rho that indicates a steep gradient */
#define const_gradient_log10_ratio 0.30103f

/*! Above this value the fluid field indicates compression over shear */
#define const_balsara_compression_threshold 0.5f

/*! Maximum contrasting of the densities */
#define const_gradient_alpha_max 2.0f

/*! Exponential suppression coefficient near rho_min, rho_max */
#define const_gradient_suppression_sharpness 2.f
...
#endif /* SWIFT_DENSITY_REACTIVE_HYDRO_PARAMETERS_H */
