 ...
 *
 ******************************************************************************/
#ifndef SWIFT_DENSITY_REACTIVE_HYDRO_PART_H
#define SWIFT_DENSITY_REACTIVE_HYDRO_PART_H

/**
 * @file DENSITY_REACTIVE/hydro_part.h
...
struct part {
  ...
  /*! Biased particle density */
  float rho_biased;
  
  /*! Particle pressure (SPH smoothed) */
  float pressure;

  /*! Biased pressure */
  float pressure_biased;

  /* Store the density-reactive information in a separate struct. */
  struct {
    /* Arithmetic mean of neighbour densities */
    float rho_mean;

    /*! Minimum density in the kernel */
    float rho_min;

    /*! Maximum density in the kernel */
    float rho_max;

    /* Sum of neighbour densities */
    float rho_sum;

    /* Density contrast indicator */
    float rho_chi;

    /* Arithmetic mean of neighbour pressures */
    float P_mean;

    /*! Minimum pressure in the kernel */
    float P_min;

    /*! Maximum pressure in the kernel */
    float P_max;

    /* Sum of neighbour pressures */
    float P_sum;

    /* Pressure contrast indicator */
    float P_chi;

    /* Total number of neighbours in the kernel */
    int num_ngb;
...
#endif /* SWIFT_DENSITY_REACTIVE_HYDRO_PART_H */
